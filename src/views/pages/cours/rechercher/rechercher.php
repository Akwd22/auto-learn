                        ...
                        <!--formulaire de gauche-->
                            <p class="titlesForm">Format cours</p>
                                <div class="divRadios" id="radio1">
                                    <?php 
                                        ...
                                        if($selectedRadio=='Texte'){$textStatus='checked';}
                                ...
                                <div class="divRadios" id="radio2">
                                    <?php 
                                        ...
                                        if($selectedRadio=='Video'){$videoStatus='checked';}
                            ...
                            <p class="titlesForm" id="titleFormCat">Catégories</p>
                                <select class="select m" name="selectCat" id="selectCat">
                                    <?php
                                        $defaultStatus='';
                                        if($selectedCat==''){$defaultStatus='selected';}
                                        $cppStatus='';
                                        if($selectedCat=='cpp'){$cppStatus='selected';}
                                        $javascriptStatus='';
                                        if($selectedCat=='javascript'){$javascriptStatus='selected';}                                        
                                    ?>
